    ...
    return (
        <div className="flex flex-col h-[700px] w-full bg-white overflow-hidden">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className={`w-full md:w-[350px] flex flex-col border-r ${selectedOrder ? 'hidden md:flex' : 'flex'}`}>
                ...
                <div className={`flex-1 flex flex-col bg-gray-50/50 ${selectedOrder ? 'flex' : 'hidden md:flex items-center justify-center'}`}>
                    {selectedOrder ? (
                        <>
                            <div className="p-4 bg-white border-b flex items-center justify-between shadow-sm">
                                ...
                                <div className="flex flex-col items-end">
                                    <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">{selectedOrder.id}</span>
                            ...
                            <div className="p-4 bg-white border-t flex gap-3 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                                ...
                                <Button 
                                    className="flex-1 h-12 font-bold gap-2 rounded-xl bg-orange-500 hover:bg-orange-600"
