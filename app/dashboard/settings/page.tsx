    ...
    >
      <Link href={section.href}>
        <div className="flex items-center gap-4 rounded-lg border border-gray-200 bg-white p-4 transition-all hover:border-indigo-300 hover:shadow-md md:p-5">
          {/* Icon */}
          <div className={`flex flex-shrink-0 items-center justify-center rounded-lg p-3 ${section.color}`}>
            {section.icon}
          </div>
          ...
          {/* Arrow */}
          <div className="flex-shrink-0 text-gray-400 transition-colors group-hover:text-indigo-600">
