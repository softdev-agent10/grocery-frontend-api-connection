                      ...
                      {taxes.map((tax) => (
                        ...
                        >
                          ...
                          <td className="p-3 md:p-4 2xl:p-6">
                            ...
                            >
                              {tax.status === 'Active' ? <ShieldCheck size={12} className="md:w-4 md:h-4 2xl:w-5 2xl:h-5" /> : <ShieldAlert size={12} className="md:w-4 md:h-4 2xl:w-5 2xl:h-5" />}
                              {tax.status}
                            </button>
                          </td>
                      ...
                      {fees.map((fee) => (
                        ...
                        >
                          ...
                          <td className="p-3 md:p-4 2xl:p-6">
                            ...
                            >
                              {fee.status === 'Active' ? <ShieldCheck size={12} className="md:w-4 md:h-4 2xl:w-5 2xl:h-5" /> : <ShieldAlert size={12} className="md:w-4 md:h-4 2xl:w-5 2xl:h-5" />}
                              {fee.status}
                            </button>
                          </td>
                          <td className="p-3 md:p-4 2xl:p-6 pr-4 md:pr-6 2xl:pr-8 text-right print:hidden">
